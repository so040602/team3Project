            ...
            <c:if test="${requestScope.keyword == ''}">
               <c:if test="${pagelist.beginPage > 10}">
                  <li class="page-item"><a class="page-link"
                     href="<%=getEnvs%>bookRaiting&pageNumber=1&currCategory=${requestScope.selectedCategory}"><i class="fa fa-step-backward" aria-hidden="true"></i></a></li><!-- 처음 -->
               </c:if>
               <c:if test="${pagelist.beginPage <= 10}">
               ...
               <c:if test="${pagelist.beginPage > 1}">
                  <li class="page-item"><a class="page-link"
                     href="<%=getEnvs%>bookRaiting&pageNumber=${pagelist.beginPage - 1}&currCategory=${requestScope.selectedCategory}"><i class="fa fa-backward" aria-hidden="true"></i></a></li><!-- 이전 -->
               </c:if>
               <c:if test="${pagelist.beginPage <= 1}">
               ...
               <c:if test="${pagelist.endPage < pagelist.totalPage}">
                  <li class="page-item"><a class="page-link"
                        href="<%=getEnvs%>bookRaiting&pageNumber=${pagelist.endPage + 1}&currCategory=${requestScope.selectedCategory}"><i class="fa fa-forward" aria-hidden="true"></i></a></li><!-- 다음 -->
               </c:if>
               <c:if test="${pagelist.endPage >= pagelist.totalPage}">
               ...
               <c:if test="${pagelist.endPage < pagelist.totalPage}">
                  <li class="page-item"><a class="page-link"
                     href="<%=getEnvs%>bookRaiting&pageNumber=${pagelist.totalPage}&currCategory=${requestScope.selectedCategory}"><i class="fa fa-step-forward" aria-hidden="true"></i></a></li><!-- 맨끝 -->
               </c:if>
               <c:if test="${pagelist.endPage >= pagelist.totalPage}">
